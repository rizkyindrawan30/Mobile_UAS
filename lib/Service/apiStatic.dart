...
class ApiStatic {
  static final host = 'http://172.16.246.186/wisata/public';
  static final _token = "7|AeI7KutfXDM56D3ItmwU26AqcrtwQcDzGb5Tgaqw";
  static gethost() {
    return host;
  }
  ...
  static Future<List<Wisata>> getWisata() async {
    ...
    try {
      final response = await http.get(Uri.parse("$host/api/wisata"), headers: {
        'Authorization': 'Barrer ' + _token,
      });
